...
* The **entity** is typed `nfdi:NFDI_0000190` (obsolete publication) and carries only its identity, its label, and links.
...
|---|---|---|
| obsolete publishing process | `nfdi:NFDI_0000014` | 231 |
...
| **Intent** | To represent a obsolete publication in the MatWerk Knowledge Graph: its identity, the value nodes that describe it, and its links to the other entities the NFDI-MatWerk consortium records. |
...
| **Has Components** | obsolete publishing process, document title, author list, digital object identifier |
