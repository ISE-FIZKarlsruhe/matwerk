...
def process_spreadsheets():
    ...
    robot_sparql_endpoints = BashOperator(task_id="robot_sparql_endpoints", bash_command=robotCmdTemplate(["req_1", "req_2", "people", "organization", "temporal", "process"], "sparql_endpoints"))
