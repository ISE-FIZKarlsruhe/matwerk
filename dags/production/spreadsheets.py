...
ONTOLOGY = "https://raw.githubusercontent.com/ISE-FIZKarlsruhe/mwo/refs/tags/v3.0.0/mwo.owl"
...
def process_spreadsheets():
    ...
    It creates a local working directory for this dag run. 
    The path is stored via xcom. 
    """
    @task
